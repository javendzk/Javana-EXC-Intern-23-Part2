...
export default function ContactMe({id}) {
    ...
    return (
        <div id={id} className="flex py-28 bg-slate-100">
            <div className="w-1/2 flex items-center justify-end">
                <h2 className="my-44 mr-1/2 text-5xl text-black font-cormorant2 leading-normal">Have a good <br></br>project idea?<br></br>Lets Chat!</h2>
            </div>
